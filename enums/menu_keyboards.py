...
HELLO_TEXT = (
    f"""🐉 سلام به <a href="https://t.me/{cohandler.config['bot']['sponsor_channel'].replace('https://t.me/','')}">ربات پرایوت وی پی ان</a> خوش آمدید 👋
...
QUESTIONS_TEXT = """<b>💡 سوالات متداول هنگام استفاده از سرویس پرایوت وی پی ان</b>

📌 پرایوت وی پی ان آیپی ثابته؟ میتونم برای صرافی های ارز دیجیتال استفاده کنم؟
🔆 بله؛ با خیال راحت میتوانید از پرایوت وی پی ان استفاده کنید. به هیچ عنوان آی پی شما تغییر نخواهد کرد و تمامی سرور ها آیپی ثابت هستند.

📌 اگر سرور های پرایوت وی پی ان برای مدتی در وضعیت 《بروزرسانی》 قرار گیرند چه اتفاقی می افتد؟ 
...
📌 پرایوت وی پی ان از چه نوع سرویسی استفاده می کند؟
🔆 پرایوت وی پی ان از Vmess/Vless استفاده می کند و شما می توانید مدیریت کامل بر روی سرویس خریداری شده خود داشته باشید.

📌 پرایوت وی پی ان از چه کشور هایی سرویس ارائه می دهد؟
...
📌 چطور باید از پرایوت وی پی ان استفاده کنم؟
...
📌 پرایوت وی پی ان سرعت اینترنت را بالا می برد؟
...
📌 آیا از پرایوت وی پی ان برای بازی های آنلاین هم می شود استفاده کرد؟
